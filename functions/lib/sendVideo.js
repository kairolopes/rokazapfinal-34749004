...
exports.sendVideo = functions.runWith({ timeoutSeconds: 120, memory: "512MB" }).https.onCall(async (data, context) => {
    if (!context.auth) {
        throw new functions.https.HttpsError("unauthenticated", "Usuário não autenticado");
    }
    const { phone, caption, conversationId, messageDocId } = data;
    const video = data.video || "";
    console.log("sendVideo - Payload recebido:", JSON.stringify({ phone, captionLength: caption === null || caption === void 0 ? void 0 : caption.length, conversationId, messageDocId, videoLength: video === null || video === void 0 ? void 0 : video.length }));
