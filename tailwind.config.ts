    ...
    extend: {
      colors: {
        ...
        whatsapp: {
          ...
          sidebar: "hsl(var(--wa-sidebar))",
          chat: "hsl(var(--wa-chat))",
          outgoing: "hsl(var(--wa-outgoing))",
          incoming: "hsl(var(--wa-incoming))",
          text: "hsl(var(--wa-text))",
          muted: "hsl(var(--wa-muted))",
          icon: "hsl(var(--wa-icon))",
          search: "hsl(var(--wa-search))",
          hover: "hsl(var(--wa-hover))",
          active: "hsl(var(--wa-active))",
          border: "hsl(var(--wa-border))",
          system: "hsl(var(--wa-system))",
